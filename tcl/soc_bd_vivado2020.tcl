...
################################################################
# This is a generated script based on design: piccolo_3
#
...
proc write_mig_file_piccolo_3_mig_7series_0_1 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>piccolo_3_mig_7series_0_1</ModuleName>}
...
# End of write_mig_file_piccolo_3_mig_7series_0_1()
...
proc create_root_design { parentCell } {
  ...
  write_mig_file_piccolo_3_mig_7series_0_1 $str_mig_file_path
  ...
  connect_bd_intf_net -intf_net axi_smc_M06_AXI [get_bd_intf_pins axi_iic_0/S_AXI] [get_bd_intf_pins axi_smc/M06_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins axi_smc/aclk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_83M/slowest_sync_clk]
  connect_bd_net -net axi_iic_0_iic2intc_irpt [get_bd_pins axi_iic_0/iic2intc_irpt] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net axi_quad_spi_flash_ip2intc_irpt [get_bd_pins axi_quad_spi_flash/ip2intc_irpt] [get_bd_pins xlconcat_0/In4]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_quad_spi_flash/ext_spi_clk] [get_bd_pins axi_quad_spi_flash/s_axi4_aclk] [get_bd_pins axi_quad_spi_flash/s_axi_aclk] [get_bd_pins axi_smc/aclk1] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins mkP1_Core_0/CLK] [get_bd_pins rst_clk_wiz_0_25M/slowest_sync_clk] [get_bd_pins xilinx_jtag_0/clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_25M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_flash/s_axi4_aresetn] [get_bd_pins axi_quad_spi_flash/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins rst_clk_wiz_0_25M/peripheral_aresetn] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconcat_0/In1] [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconcat_0/In3] [get_bd_pins xlconcat_0/In5] [get_bd_pins xlconcat_0/In7] [get_bd_pins xlconcat_0/In8] [get_bd_pins xlconcat_0/In9] [get_bd_pins xlconcat_0/In10] [get_bd_pins xlconcat_0/In11] [get_bd_pins xlconcat_0/In12] [get_bd_pins xlconcat_0/In13] [get_bd_pins xlconcat_0/In14] [get_bd_pins xlconcat_0/In15] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  assign_bd_address -offset 0x70000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master0] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x70000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master1] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x62330000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master0] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x62330000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master1] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x62310000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master0] [get_bd_addr_segs axi_iic_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x62310000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master1] [get_bd_addr_segs axi_iic_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master0] [get_bd_addr_segs axi_quad_spi_flash/aximm/MEM0] -force
  assign_bd_address -offset 0x40000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master1] [get_bd_addr_segs axi_quad_spi_flash/aximm/MEM0] -force
  assign_bd_address -offset 0x62400000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master0] [get_bd_addr_segs axi_quad_spi_flash/AXI_LITE/Reg] -force
  assign_bd_address -offset 0x62400000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master1] [get_bd_addr_segs axi_quad_spi_flash/AXI_LITE/Reg] -force
  assign_bd_address -offset 0x62300000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master0] [get_bd_addr_segs axi_uart16550_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x62300000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master1] [get_bd_addr_segs axi_uart16550_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master0] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master1] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
