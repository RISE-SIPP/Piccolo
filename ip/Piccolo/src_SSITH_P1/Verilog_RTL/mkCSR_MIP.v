...
//
// On Tue Nov 16 19:45:12 GMT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkCSR_MIP(CLK,
  ...
  wire [11 : 0] new_mip__h1066, new_mip__h594;
  wire seip__h628, ssip__h632, stip__h630, ueip__h629, usip__h633, utip__h631;
  ...
  // value method mv_read
  assign mv_read = { 20'd0, new_mip__h594 } ;

  // actionvalue method mav_write
  assign mav_write = { 20'd0, new_mip__h1066 } ;
  ...
  // register rg_ssip
  assign rg_ssip$D_IN = !EN_reset && ssip__h632 ;
  assign rg_ssip$EN = EN_mav_write || EN_reset ;

  // register rg_stip
  assign rg_stip$D_IN = !EN_reset && stip__h630 ;
  assign rg_stip$EN = EN_mav_write || EN_reset ;

  // register rg_ueip
  assign rg_ueip$D_IN = !EN_reset && ueip__h629 ;
  assign rg_ueip$EN = EN_mav_write || EN_reset ;

  // register rg_usip
  assign rg_usip$D_IN = !EN_reset && usip__h633 ;
  assign rg_usip$EN = EN_mav_write || EN_reset ;

  // register rg_utip
  assign rg_utip$D_IN = !EN_reset && utip__h631 ;
  assign rg_utip$EN = EN_mav_write || EN_reset ;

  // remaining internal signals
  assign new_mip__h1066 =
	     { rg_meip,
	       1'b0,
	       seip__h628,
	       ueip__h629,
  ...
  assign new_mip__h594 =
	     { rg_meip,
	       ...
	       rg_ssip,
	       rg_usip } ;
  assign seip__h628 = mav_write_misa[18] && mav_write_wordxl[9] ;
  assign ssip__h632 = mav_write_misa[18] && mav_write_wordxl[1] ;
  assign stip__h630 = mav_write_misa[18] && mav_write_wordxl[5] ;
  assign ueip__h629 = mav_write_misa[13] && mav_write_wordxl[8] ;
  assign usip__h633 = mav_write_misa[13] && mav_write_wordxl[0] ;
  assign utip__h631 = mav_write_misa[13] && mav_write_wordxl[4] ;
