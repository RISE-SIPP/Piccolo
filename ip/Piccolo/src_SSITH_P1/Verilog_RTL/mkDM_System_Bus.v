...
//
// On Tue Nov 16 19:45:25 GMT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_System_Bus(CLK,
  ...
  reg [63 : 0] CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q1,
	       ...
	       wrd_wdata__h4723;
  reg [7 : 0] wrd_wstrb__h4724;
  reg [2 : 0] _theResult___snd_snd_val__h4681;
  wire [63 : 0] _theResult___fst__h4666,
		addr64950_PLUS_IF_rg_sbcs_sbaccess_7_EQ_0_8_TH_ETC__q2,
		addr64__h3950,
		result__h1228,
		result__h1258,
		result__h1285,
		...
		result__h1587,
		result__h1614,
		sbaddress30_PLUS_IF_rg_sbcs_sbaccess_7_EQ_0_8__ETC__q3,
		sbaddress__h630,
		word64__h4611;
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_31_THEN_IF_rg_sbcs_sba_ETC___d314,
		v__h2261,
		v__h2374;
  wire [7 : 0] strobe64__h4664, strobe64__h4668, strobe64__h4672;
  wire [5 : 0] shift_bits__h4614;
  wire rg_sb_state_EQ_0_8_AND_NOT_rg_sbcs_sbbusyerror_ETC___d106,
       rg_sb_state_EQ_0_8_AND_NOT_rg_sbcs_sbbusyerror_ETC___d120,
       rg_sb_state_EQ_0_8_AND_NOT_rg_sbcs_sbbusyerror_ETC___d320,
       rg_sbcs_sberror_EQ_0_AND_rg_sbcs_sbreadonaddr__ETC___d298,
       write_dm_addr_EQ_0x38_48_AND_rg_sbcs_sberror_E_ETC___d263,
       write_dm_addr_EQ_0x38_48_AND_rg_sbcs_sberror_E_ETC___d272,
       write_dm_addr_EQ_0x38_48_AND_rg_sbcs_sberror_E_ETC___d278,
       write_dm_addr_EQ_0x38_48_AND_rg_sbcs_sberror_E_ETC___d280,
       write_dm_addr_EQ_0x38_48_AND_rg_sbcs_sberror_E_ETC___d285,
       write_dm_addr_EQ_0x3C_68_AND_rg_sb_state_EQ_0__ETC___d330;
  ...
  assign MUX_masterPortShim_arff$enq_1__VAL_2 =
	     { 4'd0, addr64__h3950, 8'd0, rg_sbcs_sbaccess, 18'd65536 } ;
  always@(write_dm_addr or
	  sbaddress30_PLUS_IF_rg_sbcs_sbaccess_7_EQ_0_8__ETC__q3 or
	  IF_rg_sbcs_sbreadonaddr_31_THEN_IF_rg_sbcs_sba_ETC___d314)
  begin
    case (write_dm_addr)
      7'h39, 7'h3A:
      ...
      default: MUX_rg_sbaddress0$write_1__VAL_2 =
		   sbaddress30_PLUS_IF_rg_sbcs_sbaccess_7_EQ_0_8__ETC__q3[31:0];
    endcase
  end
  ...
  assign masterPortShim_awff$D_IN =
	     { 4'd0,
	       sbaddress__h630,
	       8'd0,
	       _theResult___snd_snd_val__h4681,
	       18'd65536 } ;
  ...
  assign masterPortShim_wff$D_IN =
	     { wrd_wdata__h4723, wrd_wstrb__h4724, 2'd2 } ;
  ...
  // remaining internal signals
  assign IF_rg_sbcs_sbreadonaddr_31_THEN_IF_rg_sbcs_sba_ETC___d314 =
	     rg_sbcs_sbreadonaddr ?
	       (rg_sbcs_sbautoincrement ?
		  addr64950_PLUS_IF_rg_sbcs_sbaccess_7_EQ_0_8_TH_ETC__q2[31:0] :
		  write_dm_word) :
	       write_dm_word ;
  assign _theResult___fst__h4666 = word64__h4611 << shift_bits__h4614 ;
  assign addr64950_PLUS_IF_rg_sbcs_sbaccess_7_EQ_0_8_TH_ETC__q2 =
	     addr64__h3950 +
	     IF_rg_sbcs_sbaccess_7_EQ_0_8_THEN_1_ELSE_IF_rg_ETC___d114 ;
  assign addr64__h3950 = { rg_sbaddress1, write_dm_word } ;
  ...
  assign rg_sb_state_EQ_0_8_AND_NOT_rg_sbcs_sbbusyerror_ETC___d106 =
	     ...
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbautoincrement ;
  assign rg_sb_state_EQ_0_8_AND_NOT_rg_sbcs_sbbusyerror_ETC___d120 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadondata ;
  assign rg_sb_state_EQ_0_8_AND_NOT_rg_sbcs_sbbusyerror_ETC___d320 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadonaddr ;
  assign rg_sbcs_sberror_EQ_0_AND_rg_sbcs_sbreadonaddr__ETC___d298 =
	     rg_sbcs_sberror == 3'd0 &&
	     (rg_sbcs_sbreadonaddr && rg_sbcs_sbautoincrement ||
	      write_dm_addr != 7'h39) ;
  assign sbaddress30_PLUS_IF_rg_sbcs_sbaccess_7_EQ_0_8__ETC__q3 =
	     sbaddress__h630 +
	     IF_rg_sbcs_sbaccess_7_EQ_0_8_THEN_1_ELSE_IF_rg_ETC___d114 ;
  assign sbaddress__h630 = { rg_sbaddress1, rg_sbaddress0 } ;
  assign shift_bits__h4614 = { rg_sbaddress0[2:0], 3'b0 } ;
  assign strobe64__h4664 = 8'b00000001 << rg_sbaddress0[2:0] ;
  assign strobe64__h4668 = 8'b00000011 << rg_sbaddress0[2:0] ;
  assign strobe64__h4672 = 8'b00001111 << rg_sbaddress0[2:0] ;
  assign v__h2261 =
	     { 9'd64,
	       rg_sbcs_sbbusyerror,
	       rg_sb_state != 2'd0,
  ...
  assign v__h2374 =
	     (rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign word64__h4611 = { 32'd0, write_dm_word } ;
  assign write_dm_addr_EQ_0x38_48_AND_rg_sbcs_sberror_E_ETC___d263 =
	     write_dm_addr == 7'h38 &&
  ...
  assign write_dm_addr_EQ_0x38_48_AND_rg_sbcs_sberror_E_ETC___d272 =
	     write_dm_addr_EQ_0x38_48_AND_rg_sbcs_sberror_E_ETC___d263 ||
	     (write_dm_addr == 7'h39 || write_dm_addr == 7'h3A ||
	      write_dm_addr == 7'h3C) &&
	     rg_sb_state != 2'd0 ;
  assign write_dm_addr_EQ_0x38_48_AND_rg_sbcs_sberror_E_ETC___d278 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     rg_sbcs_sbbusyerror &&
	     !write_dm_word[22] ;
  assign write_dm_addr_EQ_0x38_48_AND_rg_sbcs_sberror_E_ETC___d280 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || write_dm_word[22]) ;
  assign write_dm_addr_EQ_0x38_48_AND_rg_sbcs_sberror_E_ETC___d285 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || write_dm_word[22]) &&
	     (write_dm_word[19:17] == 3'd4 || write_dm_word[19:17] == 3'd3) ;
  assign write_dm_addr_EQ_0x3C_68_AND_rg_sb_state_EQ_0__ETC___d330 =
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2, 3'd3:
	  _theResult___snd_snd_val__h4681 = rg_sbcs_sbaccess;
      default: _theResult___snd_snd_val__h4681 = 3'b111;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  strobe64__h4664 or strobe64__h4668 or strobe64__h4672)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: wrd_wstrb__h4724 = strobe64__h4664;
      3'd1: wrd_wstrb__h4724 = strobe64__h4668;
      3'd2: wrd_wstrb__h4724 = strobe64__h4672;
      3'd3: wrd_wstrb__h4724 = 8'b11111111;
      default: wrd_wstrb__h4724 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or word64__h4611 or _theResult___fst__h4666)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: wrd_wdata__h4723 = _theResult___fst__h4666;
      default: wrd_wdata__h4723 = word64__h4611;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
