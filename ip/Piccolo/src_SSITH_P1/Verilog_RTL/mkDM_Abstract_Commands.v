...
//
// On Tue Nov 16 19:44:39 GMT 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_Abstract_Commands(CLK,
  ...
  wire [2 : 0] MUX_rg_abstractcs_cmderr$write_1__VAL_5,
  ...
  wire [31 : 0] virt_rg_abstractcs__h505, virt_rg_command__h551;
  wire [15 : 0] regno__h1903;
  wire [12 : 0] x__h1037;
  wire rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d35,
       rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d46,
       rg_abstractcs_cmderr_read__0_EQ_0_6_AND_write__ETC___d107,
       rg_abstractcs_cmderr_read__0_EQ_0_6_AND_write__ETC___d139,
  ...
  always@(av_read_dm_addr or
	  rg_data0 or virt_rg_abstractcs__h505 or virt_rg_command__h551)
  begin
    case (av_read_dm_addr)
      7'h16: av_read = virt_rg_abstractcs__h505;
      7'h17: av_read = virt_rg_command__h551;
  ...
  assign MUX_f_hart0_gpr_reqs$enq_1__VAL_1 =
	     { 1'd1, x__h1037[4:0], rg_data0 } ;
  assign MUX_f_hart0_gpr_reqs$enq_1__VAL_2 =
	     { 1'd0,
	       x__h1037[4:0],
	       32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  } ;
  assign MUX_rg_abstractcs_cmderr$write_1__VAL_5 =
  ...
  case (1'b1)
    ...
    WILL_FIRE_RL_rl_csr_read_finish || WILL_FIRE_RL_rl_csr_write_finish:
	rg_abstractcs_busy$D_IN = 1'd0;
  ...
  case (1'b1)
    ...
    WILL_FIRE_RL_rl_gpr_write_start || WILL_FIRE_RL_rl_csr_read_start ||
    WILL_FIRE_RL_rl_csr_write_start:
	rg_start_reg_access$D_IN = 1'd0;
  ...
  // remaining internal signals
  assign regno__h1903 = { 3'd0, rg_command_access_reg_regno } ;
  assign rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d35 =
	     rg_abstractcs_busy && rg_start_reg_access &&
	     rg_command_access_reg_write &&
	     !rg_command_access_reg_regno_read_ULT_0x1000___d31 &&
	     rg_command_access_reg_regno_read_ULE_0x101F___d33 ;
  assign rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d46 =
	     rg_abstractcs_busy && rg_start_reg_access &&
	     !rg_command_access_reg_write &&
	     !rg_command_access_reg_regno_read_ULT_0x1000___d31 &&
	     rg_command_access_reg_regno_read_ULE_0x101F___d33 ;
  assign rg_abstractcs_cmderr_read__0_EQ_0_6_AND_write__ETC___d107 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     write_dm_word[24] ;
  assign rg_abstractcs_cmderr_read__0_EQ_0_6_AND_write__ETC___d139 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
  ...
  assign virt_rg_abstractcs__h505 =
	     { 19'd0, rg_abstractcs_busy, 1'b0, rg_abstractcs_cmderr, 8'd1 } ;
  assign virt_rg_command__h551 =
	     { 15'd17, rg_command_access_reg_write, regno__h1903 } ;
  ...
  assign x__h1037 = rg_command_access_reg_regno - 13'h1000 ;
  ...
  begin
    ...
    v__h3458 = v__h3464 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 &&
	  rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr != 7'h17 &&
	  write_dm_addr != 7'h04)
	$write("%0d: DM_Abstract_Commands.write: [", v__h3458);
    if (RST_N != `BSV_RESET_VALUE)
